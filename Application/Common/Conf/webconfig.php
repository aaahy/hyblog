...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '备案号暂无',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'aaahy2011@sina.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '胡洋博客',             //网站名：
    'WEB_KEYWORDS'              =>  '胡洋,技术博客,个人博客,hyblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  '胡洋的个人技术博客',      //网站描述
    'AUTHOR'                    =>  '胡洋',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为胡洋原创文章,转载无需和我联系,但请注明来自胡洋博客XXXX.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '胡洋博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '0',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'huyang.com',      //文字水印内容
